...
(function(mod) {
  ...
  var MergeView = CodeMirror.MergeView = function(node, options) {
    ...
    if (hasLeft) {
      ...
      wrap.push(leftPane);
      wrap.push(buildGap(left, options.lockTooltip));
    }
    ...
    if (hasRight) {
      ...
      wrap.push(buildGap(right, options.lockTooltip));
    ...
    editPane.appendChild(elt("div", options.valueContentTitle || "Actual content", "CodeMirror-merge-caption-title"));
    if (right) rightPane.appendChild(elt("div", options.origContentTitle || "Expected content", "CodeMirror-merge-caption-title"));
  ...
  function buildGap(dv, lockTitle) {
    var lock = dv.lockButton = elt("div", null, "CodeMirror-merge-scrolllock");
    lock.title = lockTitle || "Toggle locked scrolling";
